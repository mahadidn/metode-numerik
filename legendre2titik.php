...
<head>
    ...
    <title>Gauss Legendre 2 Point Calculation</title>
...
<body>
    ...
    <div class="container">
            ...
            <h1>Perhitungan Menggunakan Metode Gaus Legendre 2 Titik</h1>
            <form>
            ...
            <button onclick="gaussLegendre2Points()">Hitung</button>
            <p id="result"></p>
    ...
    <script>
        function gaussLegendre2Points() {
            ...
            const result = (upperBound - lowerBound) / 2 * (w1 * f((upperBound - lowerBound) / 2 * x1 + (upperBound + lowerBound) / 2) + w2 * f((upperBound - lowerBound) / 2 * x2 + (upperBound + lowerBound) / 2));
